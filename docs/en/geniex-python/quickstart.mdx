...
<CardGroup cols={3}>
  <Card title="macOS" icon="apple" href="/en/geniex-python/platform-guides/macos">
    **Apple Silicon optimized**<br/>
    Python 3.10 • MLX backend • Metal acceleration
  </Card>
  <Card title="Windows x64" icon="windows" href="/en/geniex-python/platform-guides/windows-x64">
