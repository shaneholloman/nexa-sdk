...
<AccordionGroup>
  ...
  <Accordion title="Which precision (quantization) should I pick?">
    For llama.cpp on Snapdragon NPU: **`Q4_0`**. It has the best Hexagon NPU support. Qualcomm AI Hub Models are pre-quantized — no choice. See [Precisions (Quantizations) & device placement](/en/models/supported#precisions-quantizations--device-placement).
  </Accordion>
</AccordionGroup>
