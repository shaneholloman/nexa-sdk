...
<AccordionGroup>
  ...
  <Accordion title="How do I set a Hugging Face token for gated models?">
...
<AccordionGroup>
  <Accordion title="How do I install Python on a Linux ARM64 device?" id="how-do-i-install-python-on-a-linux-arm64-device">
    GenieX requires **ARM64** Python. x86_64 / AMD64 builds are not supported, even under emulation.
  ...
  <Accordion title="Is Miniconda supported on Windows ARM64?">
