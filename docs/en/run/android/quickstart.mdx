...
- **Model picker UI** — the dropdown is driven by `examples/android/src/main/assets/model_list.json`. Each entry pins a `model_name`, `hub`, and (for QAIRT) a `chipset`. Edit this file to add new models without touching code.
