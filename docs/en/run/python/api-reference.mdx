...
| `quant` | `str \| None` | `None` | Precision (quantization) variant (e.g. `"Q4_K_M"`). Filters files when downloading from Hub. |
...
| `quant` | `str \| None` | `None` | Precision (quantization) hint (e.g. `"Q4_K_M"`). |
